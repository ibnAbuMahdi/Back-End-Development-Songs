...
def songs():
    return {"songs":json.loads(json_util.dumps(db.songs.find({})))}, 200
...
def update_song(id):
    ...
    if found:
        update = db.songs.update_one({"id": id}, {'$set': song})
